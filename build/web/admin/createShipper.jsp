...
<body>
<div class="create-shipper-container">
    <div class="form-title">
        <i class="fas fa-truck"></i> Tạo tài khoản Shipper
    </div>
    ...
    <% } %>
    <form action="<%=request.getContextPath()%>/admin/create-shipper" method="post" autocomplete="off">
        <div class="mb-3">
