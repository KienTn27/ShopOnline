...
<body>
    ...
    <a href="revenue-table" class="btn-summary-table">
        <span style="font-size:1.3em;vertical-align:middle;">📋</span>
        <span style="vertical-align:middle;"> Bảng tổng hợp doanh thu</span>
    </a>
    <%
    ...
    <div class="dashboard">
            ...
            <div class="charts-grid">
                ...
                <div class="chart-card">
                    <div class="chart-header">
                        ...
                        <div class="chart-actions">
                            <button class="chart-btn" onclick="downloadChart('revenueChart')" title="<Tải xuống">
                                <span class="btn-icon">📥</span>
                            </button>
                        </div>
                    </div>
                ...
                <div class="chart-card">
                    <div class="chart-header">
                        ...
                        <div class="chart-actions">
                            <button class="chart-btn" onclick="downloadChart('ordersChart')" title="Tải xuống">
                                <span class="btn-icon">📥</span>
                            </button>
                        </div>
                    </div>
        ...
        <!-- ĐÃ XÓA BẢNG TỔNG HỢP DOANH THU, chỉ còn dashboard, biểu đồ, tổng quan -->
    </div>
