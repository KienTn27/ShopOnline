...
<html lang="vi">
    ...
    <body>
        <div class="container">
            ...
            <c:if test="${currentUser.role eq 'SuperAdmin'}">
                <a href="${pageContext.request.contextPath}/admin/create-admin" class="btn btn-primary mb-3">
                    <i class="fas fa-plus-circle"></i> Tạo tài khoản Admin
                </a>
            </c:if>
            <c:if test="${currentUser.role eq 'Admin'}">
                <a href="${pageContext.request.contextPath}/admin/create-shipper" class="btn btn-primary mb-3">
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <form method="post" action="user-management" style="display:inline;">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${user.isActive}">
                                                            <c:if test="${(currentUser.role eq 'SuperAdmin' && user.role ne 'SuperAdmin') || (currentUser.role eq 'Admin' && (user.role eq 'Customer' || user.role eq 'Shipper'))}">
                                                ...
                                                <form method="post" action="user-management" style="display:inline;" onsubmit="return confirm('Bạn có chắc chắn muốn xóa người dùng này? Hành động này không thể hoàn tác!');">
                                                    <input type="hidden" name="userId" value="${user.userId}" />
                                                    <c:if test="${currentUser.role eq 'SuperAdmin' && user.role ne 'SuperAdmin'}">
