...
<head>
    ...
    <style>
        ...
        .order-status-pending { background: #fffbe6; color: #bfa100; }
        .order-status-processing { background: #e0f7fa; color: #007b8a; }
        .order-status-confirmed { background: #e6ffed; color: #1e7e34; }
        .order-status-shipped { background: #ede7f6; color: #6f42c1; }
        .order-status-delivered { background: #e6fffa; color: #20c997; }
        .order-status-cancelled { background: #ffeaea; color: #dc3545; }
        .order-action-btn {
            padding: 7px 18px;
            border-radius: 7px;
            font-weight: 500;
        ...
        @media (max-width: 900px) {
            .order-table-container { padding: 1rem 0.2rem; }
