                        ...
                        <div class="pagination">
                            <%
                                ...
                                if (totalPages != null && totalPages > 1) {
                                    // Nút Trang đầu
                                    if (currentPage > 1) {
                                        out.print("<a href='average-revenue?page=1' class='page-btn'>&laquo;</a>");
                                    } else {
                                        out.print("<span class='page-btn disabled'>&laquo;</span>");
                                    }
                                    // Nút Trước
                                    if (currentPage > 1) {
                                    ...
                                    // Nút Trang cuối
                                    if (currentPage < totalPages) {
                                        out.print("<a href='average-revenue?page=" + totalPages + "' class='page-btn'>&raquo;</a>");
                                    } else {
                                        out.print("<span class='page-btn disabled'>&raquo;</span>");
                                    }
                                }
                            %>
                        </div>
