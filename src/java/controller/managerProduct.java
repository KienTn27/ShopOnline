...
public class managerProduct extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Product> filteredProducts = getFilteredProducts(searchKeyword, categoryId, priceFrom, priceTo);
            ...
            List<Product> paginatedProducts = paginateProducts(filteredProducts, page, PAGE_SIZE);
     ...
     */
    private List<Product> getFilteredProducts(String searchKeyword, Integer categoryId, 
     ...
     * Thêm tên danh mục cho mỗi sản phẩm
     */
    private void addCategoryNameToProducts(List<Product> products) {
