...
public class CategoryDAO {
    ...
    public boolean forceDeleteCategory(int categoryId) {
        ...
        try {
            ...
            try (PreparedStatement st1 = connection.prepareStatement(deleteProductsSql)) {
                st1.setInt(1, categoryId);
                st1.executeUpdate();
            }

            // Delete the category
            try (PreparedStatement st2 = connection.prepareStatement(deleteCategorySql)) {
    ...
    public static void main(String[] args) {
        ...
        // Test search
        List<Category> searchResults = dao.searchCategories("phone");
        System.out.println("Search results: " + searchResults.size());

        // Test add category
        Category newCategory = new Category(0, "Test Category", "Test Description");
        boolean added = dao.addCategory(newCategory);
